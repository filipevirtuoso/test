      ...
      <FormContainer>
        ...
        <Form onSubmit={submitHandler}>
          ...
          <Form.Group controlId='coordinates' className=''>
            <Form.Label>
              {lang === 'Português' ? 'Coordenadas' : 'Katitiöpë Kurehá'}
            </Form.Label>
            <Form.Control
              type='text'
              value={coordinates}
        ...
        >
          ...
          <Form.Group controlId='date_occurrence' className='mt-3'>
            <Form.Label>
              {lang === 'Português' ? 'Informe a data' : 'Të Wakara Wahiai'}
            </Form.Label>
            <Form.Control
              type='date'
          ...
          <Form.Group controlId='time_occurrence' className='mt-2'>
            <Form.Label>
              {lang === 'Português' ? 'Informe o horário' : 'Uximoto Wahimiai'}
            </Form.Label>
            <Form.Control
              type='time'
          ...
          <Wrapper>
            <MyButton type='submit' variant='success' className='mt-4 mb-5'>
              {lang === 'Português' ? 'Enviar' : 'Ximië'}
            </MyButton>
            {/* { isLoading && <Loader />} */}
          </Wrapper>
        </Form>
