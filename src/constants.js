export const BASE_URL = (process.env.REACT_APP_API =
  'https://monitoramento.conafer.org');
...
export const USER_DETAIL_URL = `/api/v1/user/detail/`;
...
export const REACT_APP_CLIENT_SECRET =
  'lqfTF7ZXSLJwG25JmwSQyU3YIbHk3d8EFiAg6u7wW0O9dkYn2ZhLRauRDPbNwQyRDtkqzYQBYmXDqC36CdTn7mu5ImjgPbRyhf6Mvvjp2eEPeP2dHrr6O63cXHiJwLYn';
